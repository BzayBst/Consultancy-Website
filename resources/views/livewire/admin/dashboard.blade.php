...
<style>
.dashboard-wrap { padding: 32px 28px; }
...
.dash-header h1 {
    ...
    font-size: 24px; color: #0d1560; margin-bottom: 4px;
}
.dash-header p { font-size: 14px; color: #555; }
...
.dash-stat:hover { border-bottom-color: #cc2222; transform: translateY(-3px); }
.dash-stat-icon {
    width: 48px; height: 48px; border-radius: 10px;
    display: flex; align-items: center; justify-content: center; font-size: 22px;
    flex-shrink: 0;
}
.dash-stat strong { display: block; font-size: 26px; color: #0d1560; font-weight: 700; }
.dash-stat span { font-size: 12px; color: #555; }
...
.dash-action {
    ...
    font-size: 14px; font-weight: 500; color: #0d1560;
    text-decoration: none; transition: all .2s;
}
.dash-action:hover { border-color: #2952e3; color: #2952e3; background: #e8edfd; }
