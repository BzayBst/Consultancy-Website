...
class ContactCms extends Component
{
    ...
    public string $branch_location_label_ja = '';
    ...
    public string $branch_weekday_hours_ja = '';
    public string $branch_saturday_hours = '';
    public string $branch_saturday_hours_ja = '';
    ...
    public function saveBranch(): void
    {
        $data = $this->validate([
            ...
            'branch_location_label_ja' => ['nullable', 'string', 'max:160'],
            ...
            'branch_weekday_hours_ja' => ['nullable', 'string', 'max:120'],
            'branch_saturday_hours' => ['nullable', 'string', 'max:120'],
            'branch_saturday_hours_ja' => ['nullable', 'string', 'max:120'],
        ...
        BranchOffice::updateOrCreate(
            ...
            [
                ...
                'location_label_ja' => $data['branch_location_label_ja'] ?? null,
                ...
                'weekday_hours_ja' => $data['branch_weekday_hours_ja'] ?? null,
                'saturday_hours' => $data['branch_saturday_hours'],
                'saturday_hours_ja' => $data['branch_saturday_hours_ja'] ?? null,
    ...
    public function editBranch(int $id): void
    {
        ...
        $this->branch_location_label_ja = $branch->location_label_ja ?? '';
        ...
        $this->branch_weekday_hours_ja = $branch->weekday_hours_ja ?? '';
        $this->branch_saturday_hours = $branch->saturday_hours ?? '';
        $this->branch_saturday_hours_ja = $branch->saturday_hours_ja ?? '';
    ...
    public function resetBranchForm(): void
    {
        ...
        $this->branch_location_label_ja = '';
        $this->branch_address = '';
        $this->branch_address_ja = '';
        $this->branch_phone = '';
        $this->branch_email = '';
        $this->branch_weekday_hours = '';
        $this->branch_weekday_hours_ja = '';
        $this->branch_saturday_hours = '';
        $this->branch_saturday_hours_ja = '';
